...
#conv_1 = CNNBlock(32,kernel_size=1)
#x_conv_1 = conv_1(x_train)
#len(x_conv_1)
#for i in range(len(x_conv_1)):
#    print(x_conv_1[i].shape) # tf.Tensor: shape=(3, 416, 416, 32)
...
#conv_1 = ResidualBlock(3)
#x_conv_1 = conv_1(x_train) # tf.Tensor: shape=(3, 416, 416, 32)
############
############
...
############
############
#conv_1 = CSPBlock(channels=64)
#x_conv_1 = conv_1(x_train)
#x_conv_1.shape # tf.Tensor: shape=(3, 208, 208, 128)
############
############
...
############
############
#conv_1 = backbone_layers()
#output_backbone = conv_1(x_train)
#for i in range(3):
#    print(output_backbone[i].shape) # tf.Tensor: shape=(3, 208, 208, 128)
############
############
...
############
#conv_1 = max_pool()
#x_conv_1 = conv_1(x_conv_1[2])
#x_conv_1.shape
# tf.Tensor: shape=(3, 208, 208, 128)
############
############
...
############
#conv_1 = concat(256)
#x_conv_1 = conv_1(x_conv_1[2], x_conv_1[2])
#x_conv_1.shape
# tf.Tensor: shape=(3, 208, 208, 128)
############
############
...
############
#conv_1 = yolov4_neck()
#output_neck = conv_1(output_backbone)
#for i in range(3):
#    print(output_neck[i].shape) # tf.Tensor: shape=(3, 208, 208, 128)
############
############
...
############
############
#conv_1 = ScalePrediction(in_channels=3, num_classes=20)
#x_conv_1 = conv_1(x_train)
#x_conv_1.shape # TensorShape([3, 416, 416, 3, 25])
############
############
...
############
#conv_1 = concat_head(256)
#x_conv_1 = conv_1(output_neck[0], output_neck[0])
#x_conv_1.shape # TensorShape([3, 416, 416, 3, 25])
############
############
...
############
#conv_1 = yolov4_head()
#output_head = conv_1(output_neck)
#for i in range(3):
#    print(output_head[i].shape)
############
############
